...
struct CustomerChatSystemNotice: View {
    let text: String
...
struct CustomerCameraPicker: UIViewControllerRepresentable {
...
struct CustomerDocumentPicker: UIViewControllerRepresentable {
    var onPick: (URL) -> Void
