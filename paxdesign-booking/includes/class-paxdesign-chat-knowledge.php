...
class PAXdesign_Chat_Knowledge {
    ...
    public static function build_cybercrime_support_context_block($language = '', $focus_reference = '') {
        ...
        $lines = array(
            ...
            '- After facts are saved, continue the workflow: Identity → Incident → Evidence → Review. Identify what is still missing, execute the next required action, and ask only for genuinely missing required information.',
            '- When Identity is complete, move to Incident. When Incident is complete, request evidence uploads. When evidence is attached, show the Review summary (what will be submitted and what is still missing). When all requirements and declarations are satisfied, submit this same CCS case.',
