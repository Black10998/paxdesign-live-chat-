...
define('PAXDESIGN_BOOKING_VERSION', '3.175.11');
...
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-document-checks.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-i18n.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-tickets.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-admin-reminders.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-ai-case.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-ai-operations.php';
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-cybercrime-ai-workflow.php';
...
if (class_exists('PAXdesign_Cybercrime_Admin_Reminders')) {
    PAXdesign_Cybercrime_Admin_Reminders::init();
}
if (class_exists('PAXdesign_Cybercrime_AI_Case')) {
    PAXdesign_Cybercrime_AI_Case::init();
}
...
class PAXdesign_Booking {
    ...
    public function register_settings() {
        ...
        register_setting('paxdesign_booking_settings', 'paxdesign_apple_web_key_id', array(
            'sanitize_callback' => 'sanitize_text_field',
        ));
        ...
        register_setting('paxdesign_booking_settings', 'paxdesign_github_client_id', array(
            'sanitize_callback' => 'sanitize_text_field',
        ));
        register_setting('paxdesign_booking_settings', 'paxdesign_github_client_secret', array(
            'sanitize_callback' => function ($value) {
                return PAXdesign_Chat::sanitize_secret_option($value, 'paxdesign_github_client_secret');
            },
        ));
        register_setting(
