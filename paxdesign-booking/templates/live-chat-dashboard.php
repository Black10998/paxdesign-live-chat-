        ...
        <div class="pax-live-dashboard__chat-footer">
          ...
          <div class="pax-live-dashboard__compose" id="paxLiveChatCompose">
            ...
            <div class="pax-live-dashboard__compose-row">
              <button type="button" class="pax-live-dashboard__quick-links" id="paxLiveChatQuickLinks" title="Website-Links senden" aria-label="Website-Links senden" hidden>+</button>
