...
alb_ok(strpos($svg, 'viewBox="0 0 512 512"') !== false && strpos($svg, 'gradient') === false, 'scanner device uses a compact professional smartphone SVG');
alb_ok(strpos($css, 'width: 40px; height: 40px') !== false && strpos($css, 'height: 74px') === false, 'device mark uses square icon size, not a long narrow frame');
