...
alb_ok(strpos($css, 'position: fixed') !== false && strpos($css, 'bottom: 0') !== false && strpos($css, 'margin-left: 220px') !== false, 'desktop sidebar stays pinned for the full viewport height');
alb_ok(strpos($css, 'position: static') !== false && strpos($css, 'margin-left: 0') !== false, 'mobile sidebar is not fixed');
