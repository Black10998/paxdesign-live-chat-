...
mi_assert(strpos($bootstrap, "PAXDESIGN_BOOKING_VERSION', '3.174.128'") !== false, 'Plugin version must be 3.174.128');
...
mi_assert(strpos($chat_js, 'Version: 3.174.128') !== false, 'Chat JS must be cache-bust 3.174.128');
...
echo "OK: merge-integration checks passed (levels, badge, username, mobile menu, avatars, 3.174.128 baseline, toolbar removed)\n";
