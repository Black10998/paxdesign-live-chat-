...
mi_assert(strpos($bootstrap, "PAXDESIGN_BOOKING_VERSION', '3.174.103'") !== false, 'Plugin version must be 3.174.103');
...
mi_assert(strpos($chat_js, 'Version: 3.174.103') !== false, 'Chat JS must be cache-bust 3.174.103');
...
echo "OK: merge-integration checks passed (levels, badge, username, mobile menu, avatars, 3.174.103 baseline, toolbar removed)\n";
