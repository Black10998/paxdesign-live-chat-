...
mi_assert(strpos($bootstrap, "PAXDESIGN_BOOKING_VERSION', '3.174.123'") !== false, 'Plugin version must be 3.174.123');
...
mi_assert(strpos($chat_js, 'Version: 3.174.123') !== false, 'Chat JS must be cache-bust 3.174.123');
...
echo "OK: merge-integration checks passed (levels, badge, username, mobile menu, avatars, 3.174.123 baseline, toolbar removed)\n";
