<?php
/**
 * Guard: GitHub paxdesign-booking must match the live 3.174.124 baseline.
...
pb_ok(strpos($boot, "define('PAXDESIGN_BOOKING_VERSION', '3.174.124')") !== false, 'plugin version 3.174.124');
pb_ok(strpos($js, 'Version: 3.174.124') !== false, 'chat-script cache-bust 3.174.124');
...
echo "Production baseline 3.174.124 guards passed.\n";
