<?php
/**
 * Guard: GitHub paxdesign-booking must match the live 3.174.123 baseline.
...
pb_ok(strpos($boot, "define('PAXDESIGN_BOOKING_VERSION', '3.174.123')") !== false, 'plugin version 3.174.123');
pb_ok(strpos($js, 'Version: 3.174.123') !== false, 'chat-script cache-bust 3.174.123');
...
echo "Production baseline 3.174.123 guards passed.\n";
