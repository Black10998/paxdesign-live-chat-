...
assert_true(strpos($boot, "define('PAXDESIGN_BOOKING_VERSION', '3.174.122')") !== false, 'plugin version 3.174.122');
assert_true(strpos($js, 'Version: 3.174.122') !== false, 'chat-script cache-bust 3.174.122');
...
assert_true(strpos($js, "context: 'page'") !== false, 'inline auth uses website page context');
assert_true(strpos($js, 'releaseChatShellLoader') !== false, 'JS releases shell loader before background sync');
