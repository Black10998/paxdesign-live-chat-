...
assert_true(strpos($boot, "define('PAXDESIGN_BOOKING_VERSION', '3.174.123')") !== false, 'plugin version 3.174.123');
assert_true(strpos($js, 'Version: 3.174.123') !== false, 'chat-script cache-bust 3.174.123');
