...
TR = {
    ...
    "Discover": ("Entdecken", "استكشف"),
    "All services": ("Alle Services", "جميع الخدمات"),
    "Content unavailable": ("Inhalt nicht verfügbar", "المحتوى غير متاح"),
    "Start order": ("Auftrag starten", "بدء الطلب"),
    "Browse portfolio": ("Portfolio ansehen", "تصفح الأعمال"),
    "Explore services": ("Services entdecken", "استكشف الخدمات"),
    "About us": ("Über uns", "من نحن"),
    "Legal & Support": ("Rechtliches & Support", "القانون والدعم"),
    "Start a request": ("Anfrage starten", "بدء طلب"),
    "Every service from our studio — images, details, and native ordering.": (
    ...
    "Professional digital services — native, fast, and always up to date from our studio.": (
        "Professionelle digitale Services — nativ, schnell und immer aktuell aus unserem Studio.",
        "خدمات رقمية احترافية — أصلية وسريعة ومحدّثة دائماً من استوديونا.",
    ),
    "Your active projects will appear here once our team assigns work to your account. Explore our portfolio or start a service request.": (
        "Ihre aktiven Projekte erscheinen hier, sobald unser Team Arbeit zuweist. Entdecken Sie unser Portfolio oder starten Sie eine Service-Anfrage.",
        "ستظهر مشاريعك النشطة هنا بمجرد أن يخصص فريقنا عملاً لحسابك. استكشف أعمالنا أو ابدأ طلب خدمة.",
    ),
    "Our latest work will appear here once published.": (
        "Unsere neuesten Arbeiten erscheinen hier nach Veröffentlichung.",
        "ستظهر أحدث أعمالنا هنا بعد النشر.",
    ),
