...
// Production chat patch baseline — v3.174.117
if (!defined('ABSPATH')) {
    exit;
}
...
define('PAXDESIGN_BOOKING_VERSION', '3.174.117');
...
require_once PAXDESIGN_BOOKING_PLUGIN_DIR . 'includes/class-paxdesign-conversation-sync.php';
