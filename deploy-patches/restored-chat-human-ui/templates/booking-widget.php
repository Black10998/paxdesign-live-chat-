...
>
  ...
  >
    ...
    <span class="paxdesign-booking-launcher-label">Support-Nachricht</span>
  </div>
          ...
          <div class="paxdesign-booking-chat-auth-gate-inner" role="region" aria-labelledby="paxdesignChatAuthGateTitle">
            <div class="paxdesign-booking-chat-auth-gate-card">
              <div class="paxdesign-booking-chat-auth-gate-intro">
                <h3 class="paxdesign-booking-chat-auth-gate-title" id="paxdesignChatAuthGateTitle"><?php echo esc_html__('Weiter zum Live-Chat', 'paxdesign-booking'); ?></h3>
                <p class="paxdesign-booking-chat-auth-gate-sub" id="paxdesignChatAuthGateSubtitle"><?php echo esc_html__('Melden Sie sich an, um unserem Team zu schreiben.', 'paxdesign-booking'); ?></p>
              </div>
              <div class="paxdesign-booking-chat-auth-social" id="paxdesignChatAuthSocial"<?php echo $chat_social_ready ? '' : ' hidden'; ?>>
                <?php if ( $chat_github_ready ) : ?>
                <button type="button" class="paxdesign-booking-chat-auth-github-btn" data-pax-chat-github="1">
                  <span class="paxdesign-booking-chat-auth-social-icon" aria-hidden="true">
                  ...
                  <?php echo esc_html__( 'Mit GitHub anmelden', 'paxdesign-booking' ); ?>
                </button>
                <?php endif; ?>
                <?php if ( $chat_apple_ready ) : ?>
                <button type="button" class="paxdesign-booking-chat-auth-apple-btn" data-pax-chat-apple="1">
                  <span class="paxdesign-booking-chat-auth-social-icon" aria-hidden="true">
                  ...
                  <?php echo esc_html__( 'Mit Apple anmelden', 'paxdesign-booking' ); ?>
                </button>
                <?php endif; ?>
              </div>
              <div class="paxdesign-booking-chat-auth-divider" id="paxdesignChatAuthDivider"<?php echo $chat_social_ready ? '' : ' hidden'; ?> aria-hidden="true"><span>oder</span></div>
              <div class="paxdesign-booking-chat-auth-actions" id="paxdesignChatAuthActions">
                <button type="button" class="paxdesign-booking-chat-auth-login-btn" id="paxdesignChatAuthLogin"><?php echo esc_html__('Anmelden', 'paxdesign-booking'); ?></button>
              </div>
            </div>
          </div>
        </div>
