...
class PAXdesign_Widget_Performance {
    ...
    public static function finalize_widget_assets() {
        ...
        wp_enqueue_script(
            ...
            self::asset_version('assets/js/widget-loader.js'),
        ...
        wp_localize_script(
            ...
            array(
                'chatSrc' => PAXDESIGN_BOOKING_PLUGIN_URL . 'assets/js/chat-script.js?ver=' . rawurlencode(self::asset_version('assets/js/chat-script.js')),
            )
        );
    }
}
