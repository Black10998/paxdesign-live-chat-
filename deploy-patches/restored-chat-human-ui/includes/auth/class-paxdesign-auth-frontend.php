...
class PAXdesign_Auth_Frontend {
    ...
    private static function js_config() {
        ...
        return array(
            ...
            'githubWebEnabled'  => class_exists('PAXdesign_Auth_GitHub') && PAXdesign_Auth_GitHub::is_web_configured(),
            'githubStartUrl'    => class_exists('PAXdesign_Auth_GitHub') ? esc_url(PAXdesign_Auth_GitHub::web_start_url()) : '',
            'githubCallbackUrl' => class_exists('PAXdesign_Auth_GitHub') ? esc_url(PAXdesign_Auth_GitHub::web_callback_url()) : '',
