...
class PAXdesign_Customer_Chat_Bridge {
    ...
    public static function send_user_message($user_id, $session_id, $content, $extra = array()) {
        ...
        } elseif (class_exists('PAXdesign_Conversation_Sync')) {
            $message_extra['client_msg_id'] = PAXdesign_Conversation_Sync::legacy_client_msg_id($user_id, $session_id, $content);
        }
