...
- Verify live chat JS still reports `Version: 3.174.103` and does not contain `skipping stacked sync`
...
php tests/github-web-login/run.php
php tests/assistant-intent/run.php
```
